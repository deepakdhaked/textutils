    ...
    return (
        <>
            <div className="container" style={{ color: props.mode === 'dark' ? 'white' : 'black' }}>
                ...
                {/* <button type="button" className="btn btn-primary mx-2" onClick={handleSpeechClick}>Text to Speech</button> */}
                <button type="button" className="btn btn-primary mx-2" onClick={handleCopyClick}>Copy to ClipBoard</button>
